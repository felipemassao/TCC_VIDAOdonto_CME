...
namespace UnityStandardAssets.Cameras
{
    public class LookatTarget : AbstractTargetFollower
    {
        ...
        [SerializeField] private float m_Followvelocidade = 1;
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            m_FollowAngles = Vector3.SmoothDamp(m_FollowAngles, targetAngles, ref m_FollowVelocity, m_Followvelocidade);
